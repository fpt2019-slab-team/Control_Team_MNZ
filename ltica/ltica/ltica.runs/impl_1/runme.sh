...
HD_PWD='/home/users/kawamata/myPrograms/git/Control_Team_MNZ/ltica/ltica/ltica.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ltica.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ltica.tcl -notrace
