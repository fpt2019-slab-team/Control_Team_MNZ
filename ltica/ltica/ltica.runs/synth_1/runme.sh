...
HD_PWD='/home/users/kawamata/myPrograms/git/Control_Team_MNZ/ltica/ltica/ltica.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ltica.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ltica.tcl
